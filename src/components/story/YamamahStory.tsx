  ...
  return (
    <motion.section className="story-panel data-panel" animate={{ opacity: active ? 1 : 0, pointerEvents: active ? "auto" : "none" }} transition={{ duration: 0.65 }}>
      <div className="data-copy">
        ...
        <motion.p animate={{ opacity: active ? 1 : 0, filter: active ? "blur(0px)" : "blur(8px)" }} transition={{ delay: active ? 0.6 : 0, duration: 0.9, ease }}>
          نُمكّن شركات الأدوية والقطاع الصحي من فهم حركة السوق وتتبع الأدوية،
          <br />
          وتفعيل التجارب السريرية، استنادًا إلى أعلى معايير البيانات الوطنية
        </motion.p>
      </div>
